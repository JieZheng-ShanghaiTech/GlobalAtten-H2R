...
class recurrent_encoder(nn.Module):
    ...
    def forward(self, single_hm, hidden=None):
        ...
        bin_output = bin_output.permute(1, 0, 2)  # change the dim of tensor
...
args_dict = {'lr': 0.0001, 'model_name': 'attchrome', 'clip': 1, 'epochs': 2, 'batch_size': 10, 'dropout': 0.5,
             ...
             'n_bins': 200, 'bin_rnn_size': 32, 'num_layers': 1, 'unidirectional': False, 'save_attention_maps': False,
